...
impl Check for ShortIntegerPrimaryKeyCheck {
    fn describe(&self) -> CheckDescription {
        CheckDescription {
            ...
            problem: "Using SMALLINT or INT for primary keys risks ID exhaustion. Changing the type \
                      later requires an ALTER COLUMN TYPE with a full table rewrite and ACCESS EXCLUSIVE lock.".into(),
            safe_alternative: "Use BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY for auto-incrementing \
                               primary keys.".into(),
            script_path: None,
        }
    }
