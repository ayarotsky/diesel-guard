...
impl Check for CreateTableSerialCheck {
    fn describe(&self) -> CheckDescription {
        CheckDescription {
            ...
            problem: "SERIAL pseudo-types are non-standard SQL and create a separately-owned sequence object, \
                      complicating permissions, dump/restore, and replication workflows.".into(),
